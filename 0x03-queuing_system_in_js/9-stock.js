...
/**
 * Stock check
 * Data Create an array listProducts containing the list of the following products
 * Data access Create a function named getItemById
 ...
 * the current available stock (by using getCurrentReservedStockById)
